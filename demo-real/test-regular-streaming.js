// Test regular streaming performance
const testRegularStreaming = async () => {
    console.log('🌊 Testing regular streaming performance...');
    ...
    try {
        ...
        console.log('📊 Regular Streaming Performance Results:');
